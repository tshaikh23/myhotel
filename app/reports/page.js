...
const Reports = () => {
  ...
  const handlePrintLan = async () => {
    ...
    const printableContent = `
    ${hotelInfo.hotelName.padEnd(40)} 
    Daily Manager Reports  
    Today's Date: ${startDates.padEnd(30)} 
    Date: ${dateRange.padEnd(40)}
-----------------------------------------------
  Subtotal       : ${Math.round(calculateTotal("subtotal")).toString().padEnd(20)}
-----------------------------------------------
  CGST           : ${Math.round(calculateTotal("CGST")).toString().padEnd(20)}
-----------------------------------------------
  SGST           : ${Math.round(calculateTotal("SGST")).toString().padEnd(20)}
-----------------------------------------------
  Menu Subtotal  : ${Math.round(calculateTotal("menuTotal")).toString().padEnd(20)}
-----------------------------------------------
  Discount       : ${Math.round(calculateTotal("discount")).toString().padEnd(20)}
-----------------------------------------------
  Cash           : ${Math.round(calculateTotal("cashAmount")).toString().padEnd(20)}
-----------------------------------------------
  Online         : ${Math.round(calculateTotal("onlinePaymentAmount")).toString().padEnd(20)}
-----------------------------------------------
  Complimentary  : ${Math.round(calculateTotal("complimentaryAmount")).toString().padEnd(20)}
-----------------------------------------------
  Credit         : ${Math.round(calculateTotal("creditAmount")).toString().padEnd(20)}
-----------------------------------------------
  Bar Subtotal   : ${Math.round(calculateTotal("barSubtotal")).toString().padEnd(20)}
-----------------------------------------------
  VAT            : ${Math.round(calculateTotal("VAT")).toString().padEnd(20)}
-----------------------------------------------
  Bar Total      : ${Math.round(calculateTotal("total")).toLocaleString("en-IN", { currency: "INR" }).padEnd(20)}
-----------------------------------------------
  Grand Total    : ${Math.round(calculateTotal("grandTotal")).toString().padEnd(20)}
-----------------------------------------------
  Last Total     : ${Math.round(calculateTotal("lastTotal")).toString().padEnd(20)}
-----------------------------------------------
    `;
    ...
    try {
      ...
      if (response.data === 'Report printed successfully') {
      ...
      alert('An error occurred while printing the report.');
    }
  };
  
  const handleDetailedPrintLan = async () => {
    const detailedPrintContent = orders.map((order, index) => ({
      srNumber: index + 1,
      billNumber: order.orderNumber.replace(/\D/g, ""),
      date: new Date(order.orderDate).toLocaleDateString("en-GB"),
    ...
    // Calculate totals for Cash, Online, and Grand Total
    const totalCash = Math.round(calculateTotal("cashAmount"));
    const totalOnline = Math.round(calculateTotal("onlinePaymentAmount"));
    const totalGrand = Math.round(calculateTotal("lastTotal"));
    ...
    Date: ${dateRange}
-----------------------------------------------
  Bill  Date    Table   Cash   Online  Total
-----------------------------------------------${detailedPrintContent.map((detail) => `
  ${detail.billNumber.toString().padEnd(2)} ${detail.date.toString().padEnd(12)} ${detail.tableName.toString().padEnd(5)} ${Math.round(detail.cash).toString().padEnd(6)} ${Math.round(detail.online).toString().padEnd(8)} ${Math.round(detail.lastTotal).toString().padEnd(5)}`).join('')} 
-----------------------------------------------
    Totals:        ${totalCash.toString().padStart(8)} ${totalOnline.toString().padStart(6)} ${totalGrand.toString().padStart(8)}
-----------------------------------------------
    Subtotal       : ${Math.round(calculateTotal("subtotal")).toString().padStart(8)}
-----------------------------------------------
    CGST           : ${Math.round(calculateTotal("CGST")).toString().padStart(8)}
-----------------------------------------------
    SGST           : ${Math.round(calculateTotal("SGST")).toString().padStart(8)}
-----------------------------------------------
    Menu Subtotal  : ${Math.round(calculateTotal("menuTotal")).toString().padStart(8)}
-----------------------------------------------
    Discount       : ${Math.round(calculateTotal("discount")).toString().padStart(8)}
-----------------------------------------------
    Cash           : ${Math.round(calculateTotal("cashAmount")).toString().padStart(8)}
-----------------------------------------------
    Online         : ${Math.round(calculateTotal("onlinePaymentAmount")).toString().padStart(8)}
-----------------------------------------------
    Complimentary  : ${Math.round(calculateTotal("complimentaryAmount")).toString().padStart(8)}
-----------------------------------------------
    Credit         : ${Math.round(calculateTotal("creditAmount")).toString().padStart(8)}
-----------------------------------------------
    Bar Subtotal   : ${Math.round(calculateTotal("barSubtotal")).toString().padStart(8)}
-----------------------------------------------
    VAT            : ${Math.round(calculateTotal("VAT")).toString().padStart(8)}
-----------------------------------------------
    Bar Total      : ${Math.round(calculateTotal("total")).toLocaleString("en-IN", { currency: "INR" }).padStart(8)}
-----------------------------------------------
    Grand Total    : ${Math.round(calculateTotal("grandTotal")).toString().padStart(8)}
-----------------------------------------------
    Last Total     : ${Math.round(calculateTotal("lastTotal")).toString().padStart(8)}
-----------------------------------------------
    `;
    try {
      ...
      <table class="table">
        <tbody>
          ...
          <tr class="bg-gray-100 table_downward">
            ...
            <td class="value">₹${Math.round(calculateTotal("acAmountPercentage"))}</td>
          </tr>
          <tr class="bg-gray-100 table_downward">
            <td class="label">Cash:</td>
            <td class="value">₹${Math.round(calculateTotal("cashAmount"))}</td>
 ...
 Today's Date: ${startDates}
  ...
  Date: ${dateRange}
    ...
    <tr class="bg-gray-100 table_downward">
      <td class="label">AC:</td>
      <td class="value">₹${Math.round(calculateTotal("acPercenatgeAmount"))}</td>
    </tr>
    <tr class="bg-gray-100 table_downward">
      <td class="label">Cash:</td>
      <td class="value">₹${Math.round(calculateTotal("cashAmount"))}</td>
      ...
      <div className="container mx-auto mt-10 p-2 bg-white rounded-md shadow-md font-sans overflow-x-auto">
        ...
        <div className="mb-4 lg:flex md:flex items-center">
          ...
          {!isLanBillState && (
            ...
            <button
              className="mb-2 ml-3 md:ml-4 w-md md:w-auto bg-blue-100 text-blue-600 text-sm px-4 py-2 rounded-full font-bold hover:bg-blue-200 focus:outline-none focus:shadow-outline-blue"
              onClick={handleDetailedPrintLan}
            >
              Print Detailed
            </button>
             )}
            ...
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody>
                ...
                <tr className="bg-gray-100">
                  ...
                  <td className="px-4 py-2 whitespace-no-wrap border-b border-gray-200 font-bold">
                    ₹{Math.round(calculateTotal("acPercentageAmount"))}
                  </td>
                  <td className="px-4 py-2 whitespace-no-wrap border-b border-gray-200 font-bold">
                    {Math.round(calculateTotal("menuTotal")).toLocaleString(
                      "en-IN",
